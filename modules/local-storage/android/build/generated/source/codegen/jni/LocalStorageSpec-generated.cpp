...
NativeLocalStorageSpecJSI::NativeLocalStorageSpecJSI(const JavaTurboModule::InitParams &params)
  ...
  eventEmitterMap_["onKeyAdded"] = std::make_shared<AsyncEventEmitter<folly::dynamic>>();
  configureEventEmitterCallback();
}

std::shared_ptr<TurboModule> LocalStorageSpec_ModuleProvider(const std::string &moduleName, const JavaTurboModule::InitParams &params) {
  if (moduleName == "LocalStorage") {
